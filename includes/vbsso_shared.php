...
if (!defined('VBSSO_SHARED')) {
    ...
    define ('VBSSO_SHARED', VBSSO_PRODUCT_VERSION_1_4_12);
    ...
    define ('VBSSO_PLATFORM_FOOTER_LINK_HTML', '<div align="center" style="z-index: 3;color: #777777;clear:both;">Single Sign On provided by <a href="http://www.vbsso.com/">' . VBSSO_PRODUCT_NAME . '</a>' . '</div>');
